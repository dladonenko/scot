...
abstract class BaseUser extends BaseObject  implements Persistent {
	...
	public function setSessionKey($v)
	{
		...
		if ($this->session_key !== $v) {
			$this->session_key = $v;
			$this->modifiedColumns[] = UserPeer::SESSION_KEY;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->session_key = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setSessionKey($arr[$keys[3]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(UserPeer::SESSION_KEY)) $criteria->add(UserPeer::SESSION_KEY, $this->session_key);
