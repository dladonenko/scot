...
abstract class BaseContentPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Content';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'IsFree', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'isFree', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::IS_FREE, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'is_free', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'IsFree' => 1, 'CreatedAt' => 2, 'UpdatedAt' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'isFree' => 1, 'createdAt' => 2, 'updatedAt' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::IS_FREE => 1, self::CREATED_AT => 2, self::UPDATED_AT => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'is_free' => 1, 'created_at' => 2, 'updated_at' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ContentPeer::IS_FREE);
	...
	{
		// invalidate objects in ContentI18nPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	public static function doCountJoinContentSequence(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ContentPeer::ID, ContentSequencePeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Content objects pre-filled with their ContentSequence objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinContentSequence(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		ContentPeer::addSelectColumns($criteria);
		$startcol = (ContentPeer::NUM_COLUMNS - ContentPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Content) to $obj2 (ContentSequence)
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		ContentPeer::addSelectColumns($criteria);
		$startcol2 = (ContentPeer::NUM_COLUMNS - ContentPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Content) to the collection in $obj2 (ContentSequence)
				$obj1->setContentSequence($obj2);
	...
	{
		return $withPrefix ? ContentPeer::CLASS_DEFAULT : ContentPeer::OM_CLASS;
	}
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseContentPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseContentPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseContentPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseContentPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseContentPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseContentPeer', $values, $con))
      {
        return $sf_hook_retval;
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(ContentPeer::ID, $criteria->remove(ContentPeer::ID), $comparison);
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseContentPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseContentPeer', $values, $con, $ret);
    }
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += ContentPeer::doOnDeleteCascade($criteria, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related ContentI18n objects
			$criteria = new Criteria(ContentI18nPeer::DATABASE_NAME);
			
			$criteria->add(ContentI18nPeer::ID, $obj->getId());
			$affectedRows += ContentI18nPeer::doDelete($criteria, $con);

			// delete related ContentAttachment objects
			$criteria = new Criteria(ContentAttachmentPeer::DATABASE_NAME);
			
			$criteria->add(ContentAttachmentPeer::CONTENT_ID, $obj->getId());
	...
	/**
	 * Selects a collection of {@link Content} objects with a {@link ContentI18n} translation populated.
	 *
	 * @param Criteria  $criteria
	...
	static public function doSelectWithI18n(Criteria $criteria, $culture = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
	  ...
	  $criteria->addJoin(ContentPeer::ID, ContentI18nPeer::ID, $join_behavior);
	  $criteria->add(ContentI18nPeer::CULTURE, $culture);
	
	  foreach (sfMixer::getCallables('BaseContent:doSelectJoin:doSelectJoin') as $sf_hook)
	  {
	    call_user_func($sf_hook, 'Content', $criteria, $con);
	  }
	  ...
	  $stmt = BasePeer::doSelect($criteria, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
	      ...
	      ContentPeer::addInstanceToPool($obj1, $key1);
			...
			$key2 = ContentI18nPeer::getPrimaryKeyHashFromRow($row, $startcol);
			if ($key2 !== null) {
				$obj2 = ContentI18nPeer::getInstanceFromPool($key2);
				if (!$obj2) {
					$cls = ContentI18nPeer::getOMClass(false);
					$obj2 = new $cls();
					$obj2->hydrate($row, $startcol);
					ContentI18nPeer::addInstanceToPool($obj2, $key2);
				} // if obj2 already loaded
	
	      $obj1->setContentI18nForCulture($obj2, $culture);
			} // if joined row was not null
