...
abstract class BaseContentI18nPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Name', 'Version', 'Text', 'Id', 'Culture', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('name', 'version', 'text', 'id', 'culture', ),
		BasePeer::TYPE_COLNAME => array (self::NAME, self::VERSION, self::TEXT, self::ID, self::CULTURE, ),
		BasePeer::TYPE_FIELDNAME => array ('name', 'version', 'text', 'id', 'culture', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Name' => 0, 'Version' => 1, 'Text' => 2, 'Id' => 3, 'Culture' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('name' => 0, 'version' => 1, 'text' => 2, 'id' => 3, 'culture' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::NAME => 0, self::VERSION => 1, self::TEXT => 2, self::ID => 3, self::CULTURE => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('name' => 0, 'version' => 1, 'text' => 2, 'id' => 3, 'culture' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseContentI18nPeer', $criteria, $con);
		}
	 ...
	 *
	 * @param      ContentI18n $value A ContentI18n object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(ContentI18n $obj, $key = null)
	{
	...
	public static function doSelectJoinContent(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		ContentI18nPeer::addSelectColumns($criteria);
		$startcol = (ContentI18nPeer::NUM_COLUMNS - ContentI18nPeer::NUM_LAZY_LOAD_COLUMNS);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		ContentI18nPeer::addSelectColumns($criteria);
		$startcol2 = (ContentI18nPeer::NUM_COLUMNS - ContentI18nPeer::NUM_LAZY_LOAD_COLUMNS);
	...
	{
		return $withPrefix ? ContentI18nPeer::CLASS_DEFAULT : ContentI18nPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a ContentI18n or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseContentI18nPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseContentI18nPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseContentI18nPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseContentI18nPeer', $values, $con, $pk);
    }
	...
	/**
	 * Method perform an UPDATE on the database, given a ContentI18n or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseContentI18nPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseContentI18nPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseContentI18nPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseContentI18nPeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the content_i18n table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a ContentI18n or Criteria object OR a primary key value.
	 *
	 ...
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			foreach ($values as $value) {
				...
				$criterion->addAnd($criteria->getNewCriterion(ContentI18nPeer::CULTURE, $value[1]));
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseContentI18nPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
