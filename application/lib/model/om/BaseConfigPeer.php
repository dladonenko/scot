...
abstract class BaseConfigPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Code', 'Value', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'code', 'value', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::CODE, self::VALUE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'code', 'value', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Code' => 1, 'Value' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'code' => 1, 'value' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::CODE => 1, self::VALUE => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'code' => 1, 'value' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseConfigPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseConfigPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseConfigPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseConfigPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseConfigPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseConfigPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseConfigPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseConfigPeer', $values, $con, $ret);
    }
