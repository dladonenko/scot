...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/var/www/vhosts/scotwork.net/cgi-bin/log/api_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/var/www/vhosts/scotwork.net/cgi-bin/cache/api/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/var/www/vhosts/scotwork.net/cgi-bin/apps/api/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/www/vhosts/scotwork.net/cgi-bin/cache/api/dev/template',
  'lifetime' => 86400,
  'prefix' => '/var/www/vhosts/scotwork.net/cgi-bin/apps/api/template',
)));
