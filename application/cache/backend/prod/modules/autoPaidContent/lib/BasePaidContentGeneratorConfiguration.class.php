 ...
 */
abstract class BasePaidContentGeneratorConfiguration extends sfModelGeneratorConfiguration
{
  ...
  {
    return 'Edit paid content %%name%%';
  }

  public function getNewTitle()
  {
    return 'Create paid content';
  }
